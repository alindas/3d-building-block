...
interface SvelteComponentDev$1 {
  ...
  $on(
    event: string,
    callback: ((event: any) => void) | null | undefined,
  ): () => void;
  $destroy(): void;
  [accessor: string]: any;
}
 ...
 */
declare function immutableJSONPatch(
  document: JSONValue,
 ...
 */
declare function revertJSONPatch(
  document: JSONValue,
  operations: JSONPatchDocument,
...
declare function updateIn(
  object: JSONValue,
  path: JSONPath,
  callback: (value: JSONValue) => JSONValue,
): JSONValue;
/**
 ...
 */
declare function insertAt(
  document: JSONObject | JSONArray,
  path: JSONPath,
  value: JSONValue,
): JSONValue;
/**
...
interface JSONNodeProp {
  ...
  valueSearchResultItemsMap:
    | JSONPointerMap<ExtendedSearchResultItem[]>
    | undefined;
  selection: JSONSelection | undefined;
}
...
declare const __propDef$6: {
  props: {
    ...
    patch?:
      | ((operations: JSONPatchDocument) => Promise<JSONPatchResult>)
      | undefined;
    ...
    updateProps?:
      | ((props: JSONEditorPropsOptional) => Promise<void>)
      | undefined;
 ...
 */
declare function renderJSONSchemaEnum(
  props: RenderValueProps,
  schema: JSONSchema,
...
declare class ValueScope extends Scope {
  ...
  value(
    nameOrPrefix: ValueScopeName | string,
    value: NameValue,
  ): ValueScopeName;
...
type IsValues<T> = false extends IsUnion<T>
  ? TypeEquality<keyof T, string>
  : false;
...
(| (null extends EnumString<keyof D>
      ...
      :
          ...
          | (null extends T
              ? {
                  [K in keyof D]: [Exclude<T, null>] extends [
                    Exclude<D[K], null>,
                  ]
                    ? {
                        ref: K;
  ...
  | ((true extends NullTypeEquality<T, number>
      ...
      ? ([RequiredKeys<Exclude<T, null>>] extends [never]
          ...
          ([OptionalKeys<Exclude<T, null>>] extends [never]
            ...
            : {
                optionalProperties: {
                  [K in OptionalKeys<T>]: JTDSchemaType<
...
declare class Ajv$1 {
  ...
  errorsText(
    errors?: ErrorObject[] | null | undefined, // optional array of validation errors
...
type FormatCompare<T extends string | number> = (
  data1: T,
  data2: T,
) => number | undefined;
type AsyncFormatValidator<T extends string | number> = (
  data: T,
) => Promise<boolean>;
 ...
 */
declare function toTextContent(
  content: Content,
 ...
 */
declare function toJSONContent(
  content: Content,
  parser?: JSONParser,
): JSONContent;
/**
 ...
 */
declare function estimateSerializedSize(
  content: Content,
  maxSize?: number,
): number;
/**
...
declare function isAfterSelection(
  selection: JSONSelection | undefined,
): selection is AfterSelection;
declare function isInsideSelection(
  selection: JSONSelection | undefined,
): selection is InsideSelection;
declare function isKeySelection(
  selection: JSONSelection | undefined,
): selection is KeySelection;
declare function isValueSelection(
  selection: JSONSelection | undefined,
): selection is ValueSelection;
declare function isMultiSelection(
  selection: JSONSelection | undefined,
): selection is MultiSelection;
declare function createKeySelection(
  path: JSONPath,
  edit: boolean,
): KeySelection;
declare function createValueSelection(
  path: JSONPath,
  edit: boolean,
): ValueSelection;
...
declare function createMultiSelection(
  json: JSONValue,
  anchorPath: JSONPath,
  focusPath: JSONPath,
): MultiSelection;
...
declare function isContentParseError(
  contentErrors: unknown,
): contentErrors is ContentParseError;
declare function isContentValidationErrors(
  contentErrors: unknown,
